...
const Footer = () => {
  return (
    <div className="relative mt-16 bg-deep-purple-accent-400">
      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full  md:px-24 lg:px-8">
        <div className="grid gap-20 row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="logo flex lg:flex-row flex-col bg-yellow-300 p-5 gap-3 rounded-full items-center cursor-pointer">
            ...
            <div className="mt-4 lg:max-w-sm">
              ...
              the premier online shop for ADC and Marvel toy enthusiasts. We are dedicated to bringing you the ultimate collection of action figures, merchandise, and collectibles, allowing you to embark on epic adventures alongside your favorite.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            <div>
              <p className="tracking-wide text-teal-accent-400 text-lg font-bold">
                Category
              </p>
            ...
            <div>
              <p className="text-lg tracking-wide text-teal-accent-400 font-bold">
                DC CHARACTERS
              </p>
              <ul className="mt-2 space-y-2">
                <li>
