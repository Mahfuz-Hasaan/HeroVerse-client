      ...
      <div className="min-w-screen  flex items-center justify-center px-5 py-20">
        ...
        >
          <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-gradient-to-r from-cyan-500 to-blue-500 py-10 px-10">
              <svg
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10 border-2">
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button className="block w-full max-w-xs mx-auto login rounded-full px-3 py-3 font-semibold login bg-gradient-to-r from-cyan-500 to-blue-500 text-white hover:scale-105 transition duration-500">
                      LOGIN NOW
                    </button>
                  </div>
                </div>
              ...
              <div className="space-y-5">
                ...
                <p className="text-center font-semibold text-black">Alredy have an account? <span className="font-bold text-[#0066fff1] cursor-pointer "><Link to="/signup">Sign Up</Link></span></p>
              </div>
            </div>
          </div>
        </div>
