            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10 border-2">
              ...
              <form onSubmit={handleSignUp}>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button
                      className="block w-full max-w-xs mx-auto login rounded-full px-3 py-3 font-semibold login bg-gradient-to-r from-cyan-500 to-blue-500 text-white bg-cyan-500 shadow-lg shadow-cyan-500/50 hover:scale-105 transition duration-500"
                      type="submit"
                    >
                      SIGN UP
                    </button>
